...
public class FolderIT {
    ...
    public void folderShouldOverwriteGlobal() throws Exception {
        ...
        this.folder1.addProperty(new FolderVaultConfiguration(new VaultConfiguration("http://folder1.com", "folder-namespace", FOLDER_1_CREDENTIALS_ID, false)));
        ...
        verify(mockAccessor, times(1)).init("http://folder1.com", "folder-namespace", (VaultCredential) FOLDER_1_CREDENTIAL, false);
    ...
    public void jobInFolderShouldNotBeAbleToAccessCredentialsScopedToAnotherFolder() throws Exception {
        ...
        this.folder1.addProperty(new FolderVaultConfiguration(new VaultConfiguration("http://folder1.com", "folder-namespace", FOLDER_2_CREDENTIALS_ID, false)));
